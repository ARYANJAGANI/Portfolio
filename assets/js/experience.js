...
const exp = [
  {
    title: "Research Fellow — Nature Relationship Index (NRI)",
    cardImage: "assets/images/experience-page/nri.jpg",
    place: "iHARP Program, UMBC",
    time: "Present",
    desp: `<li>Contributing to the development of the <a href="https://hdr.undp.org/nature-relationship-index" target="_blank" style="color: inherit; text-decoration: underline;">Nature Relationship Index (NRI)</a>, a global research initiative exploring human-nature relationships across social, cultural, and ecological contexts.</li>
      <li>Built interactive dashboards and visual analytics tools for comparing country-level indicators.</li>
      <li>Developed data processing pipelines for versioned indicator datasets (v0–v022).</li>
      <li>Collaborated with interdisciplinary researchers and UNDP-linked teams to translate research insights into structured analytical frameworks.</li>`
  },
  {
